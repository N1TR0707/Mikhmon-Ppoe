...
<div style="padding-top: 7%;"  class="login-box">
  <div class="card">
    <div class="card-header">
      <h3><?= $_please_login ?></h3>
    </div>
    <div class="card-body">
      <div class="text-center pd-7">
        <img src="img/favicon.png" alt="MIKHMON Logo">
      </div>
      <div  class="text-center">
      <span style="font-size: 22px; margin: 10px;">Manage Hotspot + PPPoe</span>
      </div>
      <center>
      ...
      <table class="table" style="width:90%">
        ...
        <tr>
          <td class="align-middle text-center">
            <input style="width: 100%; margin-top:20px; height: 35px; font-weight: bold; font-size: 17px;" class="btn-login bg-primary pointer" type="submit" name="login" value="MASUK">
          </td>
        </tr>
        <tr>
          <td class="align-middle text-center">
